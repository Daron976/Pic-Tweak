...
# 📖 Pic Tweak <a name="about-project"></a>
...
<details>
  ...
  <ul>
    ...
    <li><a href="https://jestjs.io/">Fabric.js</a></li>
    <li><a href="https://jestjs.io/">Typescript</a></li>
  </ul>
</details>
...
- Run `git clone <COPIED TEXT>` in your intergrated terminal
<!--
Example commands:
...
- Run `npm install` in your integrated terminal
...
Feel free to check the [issues page](https://github.com/Daron976/Pic-Tweak/issues). 
